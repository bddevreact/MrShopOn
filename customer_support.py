...
Choose an option below or just type your question!
        ...
        try:
            ...
            if analytics:
                analytics.track_user_action(user_id, 'support_menu_opened', {'username': username})
        except Exception:
            pass
...
You can check your ticket status anytime using /support
                ...
                try:
                    analytics = globals().get('analytics')
                    if analytics:
                        analytics.track_user_action(user_id, 'support_ticket_created', {'ticket_id': ticket_id, 'category': state['category']})
                except Exception:
                    pass
                return
        ...
        if is_human_request:
            ...
            try:
                analytics = globals().get('analytics')
                if analytics:
                    analytics.track_user_action(user_id, 'support_human_agent_requested', {})
            except Exception:
                pass
...
We appreciate your patience!
        ...
        if auto_response:
            ...
            try:
                analytics = globals().get('analytics')
                if analytics:
                    analytics.track_user_action(user_id, 'support_auto_response_sent', {'matched': True})
            except Exception:
                pass
            return
...
**What would you like to do?**
            ...
            try:
                analytics = globals().get('analytics')
                if analytics:
                    analytics.track_user_action(user_id, 'support_suggestion_shown', {'reason': 'no_auto_response'})
            except Exception:
                pass
        else:
            ...
            try:
                analytics = globals().get('analytics')
                if analytics:
                    analytics.track_user_action(user_id, 'support_ack_short_message', {})
            except Exception:
                pass
...
How can we help you today?
            ...
            try:
                analytics = globals().get('analytics')
                if analytics:
                    analytics.track_user_action(user_id, 'support_menu_viewed_from_callback', {})
            except Exception:
                pass
...
Please select the category that best describes your issue:
            ...
            try:
                analytics = globals().get('analytics')
                if analytics:
                    analytics.track_user_action(user_id, 'support_create_ticket_clicked', {})
            except Exception:
                pass
...
Type your message below, or type 'cancel' to abort.
            ...
            try:
                analytics = globals().get('analytics')
                if analytics:
                    analytics.track_user_action(user_id, 'support_category_selected', {'category': category})
            except Exception:
                pass
...
Create your first ticket to get help with any issues!
                ...
                try:
                    analytics = globals().get('analytics')
                    if analytics:
                        analytics.track_user_action(user_id, 'support_my_tickets_empty', {})
                except Exception:
                    pass
            else:
                tickets_text = f"""
...
"""
                ...
                try:
                    analytics = globals().get('analytics')
                    if analytics:
                        analytics.track_user_action(user_id, 'support_my_tickets_viewed', {'count': len(user_tickets)})
                except Exception:
                    pass
...
{t(lang, 'support.faq.need_more')}
            ...
            try:
                analytics = globals().get('analytics')
                if analytics:
                    analytics.track_user_action(user_id, 'support_faq_viewed', {})
            except Exception:
                pass
...
**Average response time:** 2-4 hours
            ...
            try:
                analytics = globals().get('analytics')
                if analytics:
                    analytics.track_user_action(user_id, 'support_live_chat_info_viewed', {})
            except Exception:
                pass
...
{t(lang, 'support.agent.request.appreciate')}
            ...
            try:
                analytics = globals().get('analytics')
                if analytics:
                    analytics.track_user_action(user_id, 'support_human_agent_clicked', {})
            except Exception:
                pass
